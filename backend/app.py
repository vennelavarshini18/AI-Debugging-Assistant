...
def home():
    st.markdown("<h1 style='text-align: center; font-family: Arial, sans-serif;'>Welcome to AI Debugging Assistant</h1>", unsafe_allow_html=True)
    st.write("""
    ...
    with col1:
        ...
        st.subheader("Smart Debugging Assistant")
...
def compiler_ai():
    st.markdown("<h1 style='text-align: center; font-family: Arial, sans-serif;'>Smart Debugging Assistant</h1>", unsafe_allow_html=True)
...
def coding_guru():
    st.markdown("<h1 style='text-align: center; font-family: Arial, sans-serif;'>Coding Master</h1>", unsafe_allow_html=True)
...
def main():
    ...
    app_mode = st.sidebar.selectbox("Choose the app mode", ["Home", "Smart Debugging Assistant", "Coding Master", "Documentation Writer", "Code Translator"])

    if app_mode == "Coding Master":
        st.sidebar.header("Coding Master Settings")
    ...
    if app_mode == "Smart Debugging Assistant":
        compiler_ai()
    elif app_mode == "Coding Master":
        coding_guru()
    elif app_mode == "Code Translator":
        code_translator()
    elif app_mode == "Home":
